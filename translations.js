...
window.MCC_TRANSLATIONS = {
    common: {
        ...
        nav_program_ai: { en: "Next-Gen Applied AI Mastery", fr: "Next-Gen Applied AI Mastery" },
        ...
        nav_program_video: { en: "Video Content Creation and Social Media Management", fr: "Video Content Creation and Social Media Management" },
    ...
    home: {
        ...
        hero_proof_accred: { en: "<img class=\"accreditation-logo\" src=\"assets/ptib-designated.jpg\" alt=\"PTIRU Designated logo\"><img class=\"accreditation-logo\" src=\"assets/eqa-logo.png\" alt=\"BC EQA logo\"> PTIRU accredited and BC EQA designated", fr: "<img class=\"accreditation-logo\" src=\"assets/ptib-designated.jpg\" alt=\"Logo PTIRU désigné\"><img class=\"accreditation-logo\" src=\"assets/eqa-logo.png\" alt=\"Logo BC EQA\"> Accrédité PTIRU et désigné BC EQA" },
        ...
        path1_li1: { en: "Next-Gen Applied AI Mastery for emerging workflow and automation skills", fr: "Next-Gen Applied AI Mastery pour les compétences émergentes en automatisation et flux de travail" },
        path1_li2: { en: "Video Content Creation and Social Media Management for digital storytelling and production", fr: "Video Content Creation and Social Media Management pour la narration numérique et la production" },
    ...
    progs: {
        ...
        cat1_li2: { en: "PTIRU accredited & BC EQA designated", fr: "Accrédité PTIRU et désigné BC EQA" },
        ...
        why1_p: { en: "PTIRU accredited and BC EQA designated — recognized quality across our diploma programs.", fr: "Accrédité PTIRU et désigné BC EQA — une qualité reconnue dans nos programmes menant à un diplôme." },
        ...
        why4_p: { en: "All programs are available both in-person and online, giving you flexibility without compromising on instruction quality.", fr: "Tous nos programmes sont offerts en présentiel et en ligne, pour plus de flexibilité sans compromis sur la qualité de l'enseignement." },
    ...
    about: {
        ...
        pill_ptib: { en: "PTIRU accredited", fr: "Accrédité PTIRU" },
        ...
        credentials_title: { en: "PTIRU and BC EQA designations students can recognize", fr: "Des désignations PTIRU et BC EQA que les étudiants peuvent reconnaître" },
        ...
        credentials_ptib_title: { en: "PTIRU designated", fr: "Désigné par le PTIRU" },
        credentials_ptib_p: { en: "Metropolitan Community College is designated by the Private Training Institutions Regulatory Unit of British Columbia, supporting clear expectations for student protection, institutional standards, and approved program delivery.", fr: "Metropolitan Community College est désigné par la Private Training Institutions Regulatory Unit de la Colombie-Britannique, ce qui soutient des attentes claires en matière de protection des étudiants, de normes institutionnelles et de prestation de programmes approuvés." },
    ...
    apply: {
        ...
        before_p: { en: "Have your passport or primary ID, permit or visa document, academic records, and language test results ready as PDF or image files (max 15 MB each).", fr: "Préparez votre passeport ou pièce d'identité principale, votre permis ou visa, vos dossiers scolaires et vos résultats de test de langue en format PDF ou image (max. 15 Mo chacun)." },
        ...
        sidebar_p3_p: { en: "Pick your program, intake date, and available attendance options.", fr: "Choisissez votre programme, votre date d'admission et les options de présence disponibles." },
        sidebar_p4_strong: { en: "Step 4 — Upload documents", fr: "Étape 4 — Téléverser les documents" },
        sidebar_p4_p: { en: "Passport or primary ID, permit or visa documents, academic records, language results, then sign and submit.", fr: "Pièce d'identité, permis ou visa, dossiers scolaires, résultats de langue, puis signez et soumettez." },
        ...
        s1_sin: { en: "Social Insurance Number (if applicable)", fr: "Numéro d'assurance sociale (le cas échéant)" },
        ...
        s3_online: { en: "Online (Live)", fr: "En ligne (en direct)" },
        s3_online_self_paced: { en: "Online (Self-paced)", fr: "En ligne (à votre rythme)" },
        s3_blended: { en: "Blended", fr: "Mode hybride" },
        s3_pathway: { en: "Are you interested in a university pathway after graduation?", fr: "Souhaitez-vous un parcours universitaire après l'obtention du diplôme ?" },
        ...
        s4_english_results: { en: "Language Test Results", fr: "Résultats de test de langue" },
